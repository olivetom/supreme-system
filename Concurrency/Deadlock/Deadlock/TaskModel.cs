...
namespace Deadlock
{
    public class TaskModel
    {
        ...
        async Task Main(string[] args)
        {
            ...
            Task<Toast> ToastBreadAsync(int howManySlices)
            {
                return new Task<Toast>(() => new Toast(numberOfSlices:));
            }
        ...
        {
            int Slices;
            public Toast(int numberOfSlices)
            {
        ...
        internal struct Egg
        {
            public static async Task FryEggsAsync(int howManyEggs)
            {
                return await Task.Run(() => Console.WriteLine("FryEggsAsync"));
            }
        }
